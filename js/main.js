...
var deathState = {
    ...
    init: function() {
        this.titleText = game.make.text(game.world.centerX, game.world.centerY, "once more.", {
            font: 'bold 40px monospace',
            fill: '#fff',
            align: 'center'
        });
...
var levelCompleteState = {
    ...
    init: function() {
        this.titleText = game.make.text(game.world.centerX, game.world.centerY, "NEXT LEVEL.", {
            font: 'bold 40px monospace',
            fill: '#fff',
            align: 'center'
        });
